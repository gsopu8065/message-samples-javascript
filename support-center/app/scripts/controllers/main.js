...
angular.module('messengerApp')
  .controller('MainCtrl', function ($scope, authService, navService, channelService, $uibModal, Alerts, notify) {
    ...
    $scope.broadcastMessage = function() {
      if (!channelService.broadcastChannel) return console.log('no broadcast channel created.');
      var msg = new Max.Message({
          message: 'broadcasted!',
          type: 'text'
      });
      channelService.broadcastChannel.publish(msg);
    };
